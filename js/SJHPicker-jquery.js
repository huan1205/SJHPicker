...
var SJHPicker = {
	...
	init: function(json){
		...
		$("input[data-field=date]").click(function(){
			SJHPicker.show(this);
		});
	},
	...
	show: function(elem){
		...
		$('#sjhpicker_btn_confirm').click(function(){
	...
	generate_panel: function (y, m, d){
		...
		$('#sjhpicker_btn_premonth').click(this.pre_month);
		$('#sjhpicker_btn_preyear').click(this.pre_year);
		$('#sjhpicker_btn_nextmonth').click(this.next_month);
		$('#sjhpicker_btn_nextyear').click(this.next_year);
		
		$('#sjhpicker_btn_today').click(this.select_today);
		$('#sjhpicker_btn_cancel').click(this.cancel);
	},
